...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('price.store') }}" method="post" enctype="multipart/form-data">
		{{ method_field('POST') }}
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
						...
						<div class="formRow">
							<label class="formLeft" for="param_name">Price_min:<span class="req">*</span></label>
							<div class="formRight">
								<span class="oneTwo">
									<input name="price_min" id="param_name" _autocheck="true" type="text" value="{{ old('name') }}" style="width:200px;"/>
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
									@if($errors->has('name'))
						...
						<div class="formRow">
							<label class="formLeft" for="param_name">Price_max:<span class="req">*</span></label>
							<div class="formRight">
								<span class="oneTwo">
									<input name="price_max" id="param_name" _autocheck="true" type="text" value="{{ old('name') }}" style="width:200px;"/>
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
									@if($errors->has('name'))
