				        ...
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									...
									<input name="cate_id" id="cate_id" type="hidden" value="{{ $category->id }}">
								</span>
				    ...
				    @foreach($specification as $spec)
					        <div class="formRow">
								<div class="formRight">
									...
									<span>
										<form action="{{ route('specifition.destroy',$spec->id) }}" method="POST" accept-charset="utf-8">
											{!! csrf_field() !!}
											{!! method_field('DELETE') !!}
											<a href="{{ route('get.create.element.spec',$spec->id) }}" title="Xem chi tiết sản phẩm" class="tipS button greenB"  style="padding:5px;">
