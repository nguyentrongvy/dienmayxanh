		...
		<fieldset>
			<div class="widget">
			    ...
			    <ul class="tabs" style="margin:1px;">
	                ...
	                <!-- <li><a href="#tab2">Thuộc tính</a></li> -->
				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="slug" id="param_name" _autocheck="true" type="text" value="{{ old('slug') }}" style="width:400px;"/>
						 ...
						 <div class="formRow">
							<label class="formLeft" for="param_name">Chọn danh mục:</label>
							<div class="formRight">
