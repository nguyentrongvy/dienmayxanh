...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('product.update',$product->id) }}" method="post" enctype="multipart/form-data">
		{{ method_field('PUT') }}
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
				        ...
				        <div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="name" id="param_name" _autocheck="true" type="text" value="{{ $product->name }}" style="width:369px;"/>
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
									@if($errors->has('name'))
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="slug" id="param_name" _autocheck="true" type="text" value="{{ $product->slug }}" style="width:369px;"/>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="comany" id="param_name" _autocheck="true" type="text" value="{{ $product->comany }}" style="width:369px;"/>
									<input type="hidden" name="parent" value="0">
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
						...
						<div class="formRow">
				            ...
				            <img src="{{ $product->image }}" style="width: 200px; margin-left: 195px; height: 200px;" />
							<div class="clear"></div>
						</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="price" id="param_name" _autocheck="true" type="text" value="{{ $product->price }}" style="width:369px;"/>
								</span>
								<span name="name_autocheck" class="autocheck"></span>
								<div name="name_error" class="clear error">
									@if($errors->has('price'))
					...
					<div id='tab2' class="tab_content pd0">
					    <div class="formRow">
							<textarea name="content" id="content" class="editor">{{ $product->content }}</textarea>
					...
					<div id='tab3' class="tab_content pd0" >
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="set_title" id="param_site_title" _autocheck="true" rows="4" cols="50">{{ $product->set_title }}</textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="meta_desc" id="param_meta_desc" _autocheck="true" rows="4" cols="80">{{ $product->meta_desc }}</textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="meta_key" id="param_meta_key" _autocheck="true" rows="4" cols="80">{{ $product->meta_key }}</textarea></span>
