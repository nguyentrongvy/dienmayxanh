...
@endsection
@section('content')
	<form class="form" id="form" action="{{ route('search.store') }}" method="post" enctype="multipart/form-data">
		{{ method_field('POST') }}
		{{ csrf_field() }}
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container">
				    <div id='tab1' class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<input name="" id="param_name" _autocheck="true" type="text" value="{{ $categories->name }}" style="width:200px;" disabled/>
									<input name="cate_id" id="param_name" _autocheck="true" type="hidden" value="{{ $categories->id }}" style="width:400px;"/>
								</span>
							</div>
							<div class="clear"></div>
						</div>
