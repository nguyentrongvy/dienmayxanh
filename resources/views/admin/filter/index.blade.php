				...
				if($item['parent_id'] == $parent_id)
				{
					...
					echo "<tr class='row_'>";
						...
						echo "<td class='option'>";
							echo "<a class='insert' href='".route('get.create.filter',$item['id'])."'>Thêm</a>";
							echo "<br>";
							echo "<br>";
							echo "<a class='detail' class='btn btn-success' href='".route('filter.show',$item['id'])."'>xem chi tiết</a>";
						echo "</td>";
					echo "</tr>";
					if($menu)
					{
